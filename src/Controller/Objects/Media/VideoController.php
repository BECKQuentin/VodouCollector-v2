...
class VideoController extends AbstractController
{
    ...
    #[IsGranted("ROLE_MEMBER", message: "Seules les Membres peuvent faire ça")]
    public function videoDelete(Video $videos, ActionCategoryRepository $actionCategoryRepository, ObjectsRepository $objectsRepository, Request $request, UploadService $uploadService, ManagerRegistry $doctrine) {
        ...
        $action->setOthersValue($videos->getSrc());
        $action->setCreatedBy($this->getUser());
        $action->setCategory($actionCategoryRepository->find(2));
